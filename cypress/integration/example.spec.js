...
describe("Mi primera prueba con cypress", () => {
    ...
    it("pruebaa home pokemon", () => {
      ...
      cy.visit("https://codigo13-react-sepia.vercel.app/");
      // contains
    ...
    it("pruebas para banderas", () => {
      cy.visit("https://codigo13-react-sepia.vercel.app/flags");
    ...
    it("prueba de login", () => {
      cy.visit("https://codigo13-react-sepia.vercel.app/login");
